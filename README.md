...
1. **Shocks are portfolio-wide — there is no sector or geographic targeting.**
   `run_simulation` applies a scenario's NOI, rate, and property-value shocks to every loan.
